...
function safeFileGetContents($file_path) {
    if (file_exists($file_path)) {
        return file_get_contents($file_path);
    } else {
        return null; // Handle the missing file scenario
    }
}
...
$channel = ""; /// يوزر قناتك بدون @
$chinnl = "$channel";
$DevUser = "@$buy"; //  Dev User
$Devch = "@$buy"; // Dev Channel
$Userbot = "$tbbots"; // User Bot
//~~~~~~~~//
define('API_KEY',$token);
echo "setWebhook ~> <a href=\"https://api.telegram.org/bot".API_KEY."/setwebhook?url=".isset($_SERVER['SERVER_NAME']) ? $_SERVER['SERVER_NAME'] : 'default_value'."".$_SERVER['SCRIPT_NAME']."\">https://api.telegram.org/bot".API_KEY."/setwebhook?url=".isset($_SERVER['SERVER_NAME']) ? $_SERVER['SERVER_NAME'] : 'default_value'."".$_SERVER['SCRIPT_NAME']."</a>";
...
$update = json_decode(safeFileGetContents('php://input'));
...
/*===== dev ~ @FF8FFI =====*/
@$statjson = json_decode(safeFileGetContents("https://api.telegram.org/bot$token/getChatMember?chat_id=$chat_id&user_id=".$from_id),true);
@$status = $statjson['result']['status'];
@$statjsonrt = json_decode(safeFileGetContents("https://api.telegram.org/bot$token/getChatMember?chat_id=$chat_id&user_id=".$re_id),true);
@$statusrt = $statjsonrt['result']['status'];
@$statjsonq = json_decode(safeFileGetContents("https://api.telegram.org/bot$token/getChatMember?chat_id=$chatid&user_id=".$fromid),true);
@$statusq = $statjsonq['result']['status'];
@$info = json_decode(safeFileGetContents("https://api.telegram.org/bot$token/getChatMember?chat_id=$chat_edit_id&user_id=".$edit_for_id),true);
@$you = $info['result']['status'];
@$forchannel = json_decode(safeFileGetContents("https://api.telegram.org/bot".$token."/getChatMember?chat_id=@".$channel."&user_id=".$from_id));
@$tch = $forchannel->result->status;
/*===== dev ~ @FF8FFI =====*/
@$settings = json_decode(safeFileGetContents("data/$chat_id.json"),true);
@$settings2 = json_decode(safeFileGetContents("data/$chatid.json"),true);
@$editgetsettings = json_decode(safeFileGetContents("data/$chat_edit_id.json"),true);
@$user = json_decode(safeFileGetContents("data/user.json"),true);
@$filterget = $settings["filterlist"];

$mem = bot('getchatmemberscount',['chat_id'=>$chat_id])->result;
$cmg = safeFileGetContents("data/count/$chat_id.txt");
$cmssg = explode("\n",$cmg);
$cmsg = count($cmssg);
...
$groupinlink = json_decode(safeFileGetContents("https://api.telegram.org/bot".API_KEY."/exportChatInviteLink?chat_id=$grouplisturl[$z]"));
...
$developers_info = safeFileGetContents("data/developers/developer.txt");
$developer = explode ("\n",$developers_info);
$developers_infos = safeFileGetContents("data/developers/developers.txt");
$developers = explode("\n",$developers_infos);
$list_developers ="";
$list_developers = $list_developers.""."$developers_infos ➖➖➖➖➖➖➖";
/*===== dev ~ @FF8FFI =====*/
$nazarr_info = safeFileGetContents("data/nazar/$chat_id.txt");
$nazar  = explode("\n",$nazarr_info);
$nazarr_infos = safeFileGetContents("data/nazar/$chat_id/nazr.txt");
$nazarr = explode ("\n",$nazarr_infos);
/*===== dev ~ @FF8FFI =====*/
$carloss_info = safeFileGetContents("data/carlos/$chat_id.txt");
$carlos  = explode("\n",$carloss_info);
$carloss_infos = safeFileGetContents("data/carlos/$chat_id/crlo.txt");
$carloss = explode ("\n",$carloss_infos);
/*===== dev ~ @FF8FFI =====*/
$mangers_info = safeFileGetContents("data/manger/$chat_id.txt");
$manger  = explode("\n",$mangers_info);
$mangers_infos = safeFileGetContents("data/manger/$chat_id/mange.txt");
$mangers = explode ("\n",$mangers_infos);
/*===== dev ~ @FF8FFI =====*/
$admin_users_info = safeFileGetContents("data/admin_user/$chat_id.txt");
$admin_user  = explode("\n",$admin_users_info);
$admin_users_infos = safeFileGetContents("data/admin_user/$chat_id/mange.txt");
$admin_users = explode ("\n",$admin_users_infos);
/*===== dev ~ @FF8FFI =====*/
$mmyazs_info = safeFileGetContents("data/mmyaz/$chat_id.txt");
$mmyaz  = explode("\n",$mmyazs_info);
$mmyazs_infos = safeFileGetContents("data/mmyaz/$chat_id/mange.txt");
$mmyazs = explode ("\n",$mmyazs_infos);
/*===== dev ~ @FF8FFI =====*/
mkdir("data");
...
$setch = safeFileGetContents("SudoOrders/setch.txt");
$setchannel = safeFileGetContents("SudoOrders/setchannel.txt");
...
$join = safeFileGetContents("https://api.telegram.org/bot".$kindi."/getChatMember?chat_id=@$setch&user_id=".$from_id);
...
$from_id = $message->from->id;
$chat_id = $message->chat->id;
$statjson = json_decode(safeFileGetContents("https://api.telegram.org/bot".$API_KEY."/getChatMember?chat_id=".$chat_id."&user_id=".$from_id),true);
$status = $statjson['result']['status'];
$BGBBB = json_decode(safeFileGetContents("BGBBB.json"),true);
if($text){
...
$re_id_info = safeFileGetContents("data/developers/$chat_id.txt");
$devr = safeFileGetContents("data/developers/$chat_id/developer.txt");
$devr1 = explode("             \n",$devr);
...
if($re and $text == "تنزيل المنشئ اساسي" || $text == "تنزيل منشئ اساسي"  and in_array($re_id,$nazar)){
	$re_id_info = safeFileGetContents("data/nazar/$chat_id.txt");
	$mdrs = safeFileGetContents("data/nazar/$chat_id/nazr.txt");
	$mdrs1 = explode("             \n",$mdrs);
	$str = str_replace($re_id,"",$re_id_info);
...
if($re and $text == "تنزيل المنشئ" || $text == "تنزيل منشئ"  and in_array($re_id,$carlos)){
	$re_id_info = safeFileGetContents("data/carlos/$chat_id.txt");
	$mdrs = safeFileGetContents("data/carlos/$chat_id/crlo.txt");
	$mdrs1 = explode("             \n",$mdrs);
	$str = str_replace($re_id,"",$re_id_info);
	$str2 = str_replace(" *𓆩* [" . "@". $re_user ."] *𓆪* " . "»" . " *𓆩* `". $re_id ."` *𓆪* ","",$mdrs1);
...
if($re and $text == "تنزيل المدير" || $text == "تنزيل مدير"  and in_array($re_id,$manger)){
	$re_id_info = safeFileGetContents("data/manger/$chat_id.txt");
	$mdrs = safeFileGetContents("data/manger/$chat_id/mange.txt");
	$mdrs1 = explode("             \n",$mdrs);
	$str = str_replace($re_id,"",$re_id_info);
	$str2 = str_replace(" *𓆩* [" . "@". $re_user ."] *𓆪* " . "»" . " *𓆩* `". $re_id ."` *𓆪* ","",$mdrs1);
...
if($re and $text == "تنزيل ادمن" and in_array($re_id,$admin_user)){
	$re_id_info = safeFileGetContents("data/admin_user/$chat_id.txt");
	$admn = safeFileGetContents("data/admin_user/$chat_id/mange.txt");
	$admn1 = explode("             \n",$admn);
	$str = str_replace($re_id,"",$re_id_info);
...
if($re and $text == "تنزيل مميز"   and in_array($re_id,$mmyaz)){
	$re_id_info = safeFileGetContents("data/mmyaz/$chat_id.txt");
	$mdrs = safeFileGetContents("data/mmyaz/$chat_id/mange.txt");
	$mdrs1 = explode("             \n",$mdrs);
	$str = str_replace($re_id,"",$re_id_info);
	$str2 = str_replace(" *𓆩* [" . "@". $re_user ."] *𓆪* " . "»" . " *𓆩* `". $re_id ."` *𓆪* ","",$mdrs1);
...
bot('deletemessage',['chat_id'=>$chat_id,'message_id'=>$message_id]);}}}
# inline
$inline = json_decode(safeFileGetContents('php://input'),true);
...
$getlink = safeFileGetContents("https://api.telegram.org/bot".API_KEY."/exportChatInviteLink?chat_id=$chat_id");
...
$url = safeFileGetContents("https://api.telegram.org/bot".API_KEY."/getChatMembersCount?chat_id=$chat_id");
...
$kocke = safeFileGetContents("kocke.txt");
$sekk = safeFileGetContents("sekk.txt");
if ($add != true) {
bot('sendMessage',[
'chat_id'=>$chat_id,
...
if ($tc == 'group' | $tc == 'supergroup'){
$add = $settings["information"]["added"];
 $export = safeFileGetContents("https://api.telegram.org/bot".API_KEY."/exportChatInviteLink?chat_id=$chat_id");
...
$stat = safeFileGetContents("https://api.telegram.org/bot$token/getChatMember?chat_id=$text&user_id=".$text);
...
$s = json_decode(safeFileGetContents("http://api.telegram.org/bot".API_KEY."/getChat?chat_id=$from_id"));
$sn =$s->result->first_name;
$su =$s->result->username;
$replace = json_decode(safeFileGetContents("replace.json"),true);
...
file_put_contents("replace.json",json_encode($replace));
 ...
 $result=json_decode(safeFileGetContents("https://api.telegram.org/bot".API_KEY."/getUserProfilePhotos?user_id=$from_id"),true);
...
$blod2 = safeFileGetContents($blod1);
...
$token = "";
if($rt and $text == "لقبه"){
$a = json_decode(safeFileGetContents("https://api.telegram.org/bot$API_KEY/getChatMember?chat_id=$chat_id&user_id=$re_id"));
...
if($text == "لقبي"){
$a = json_decode(safeFileGetContents("https://api.telegram.org/bot$API_KEY/getChatMember?chat_id=$chat_id&user_id=$from_id"));
$b = $a->result->custom_title;
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"✵⁞ قبك ↫ $b",
...
$saiko = safeFileGetContents("saikoo.txt");
if($text=="ضع قوانين"){
...
$ameer = safeFileGetContents("ssaiko.txt");
if($text=="القوانين"){
...
$Api = json_decode(safeFileGetContents("https://forhassan.ml/my_ip/ImageInfo.php?url=".$url),true);
...
$s = safeFileGetContents("https://api.telegram.org/bot$API_KEY/getChatMember?chat_id=$chat_id&user_id=".$bot_id);
$ss = json_decode($s, true);
$bot = $ss['result']['status'];

mkdir("banduser");
$get_Busers = safeFileGetContents("banduser/$chat_id.txt");
$get_Buser = explode("\n",$get_Busers);
$kick = explode(" " ,$text);
if ( $status == 'creator' or $status == 'administrator' or in_array($from_id,$Dev) or in_array($from_id,$manger) or in_array($from_id,$admin_user) or in_array($from_id,$developer)) {
if($kick[0] == "ححظر" || $kick[0] == "حظر" and isset($kick[1])){
$text = str_replace(['حظر','ححظر'],'',$text);
$stat = safeFileGetContents("https://api.telegram.org/bot
...
$stat = safeFileGetContents("https://api.telegram.org/bot$API_KEY/getChatMember?chat_id=$text&user_id=".$text);
$statjson = json_decode($stat, true);
$name = $statjson['result']['user']['first_name'];
$username = $statjson['result']['user']['username'];
$id = $statjson['result']['user']['id'];
...
$sttings = json_decode(safeFileGetContents("media.json"),1);
...
mkdir("Ali");
mkdir("Ali/$chat_id");
$get = safeFileGetContents("Ali/$chat_id2/$Dataid.txt");
...
$token = API_KEY;
$mustafa = json_decode(safeFileGetContents("data/$chat_id.json"),true);
$cei = $update->edited_message->chat->id;
$cfi = $update->edited_message->from->id;
$stn = json_decode(safeFileGetContents("https://api.telegram.org/bot$API_KEY/getChatMember?chat_id=$chat_id&user_id=".$from_id),true);
$runk = $stn['result']['status'];
$result = json_decode(safeFileGetContents("https://api.telegram.org/bot$API_KEY/getChatMember?chat_id=$cei&user_id=".$cfi),true);
...
$set = safeFileGetContents("SudoOrders/set.txt");
$setch = safeFileGetContents("SudoOrders/setch.txt");
if(in_array($from_id,$Dev)){
...
mkdir("data");
mkdir("data/addrd");
$opption = safeFileGetContents("data/addrd/$chat_id/opption.txt");
$get_from_id = safeFileGetContents("data/addrd/$chat_id/from_id.txt");
$get_rd = safeFileGetContents("data/addrd/$chat_id/getrd.txt");
$opption_ = safeFileGetContents("data/addrd/opption.txt");
$get_from_id1_ = safeFileGetContents("data/addrd/from_id.txt");
$I_get_rd = safeFileGetContents("data/addrd/getrd.txt");
...
$IB_3ADLZ = safeFileGetContents("data/addrd/$chat_id/mod.txt");
$IB_4ADLZ = safeFileGetContents("data/addrd/$chat_id/media/media.txt");
...
$IB_3ADLZ = safeFileGetContents("data/addrd/mod.txt");
$IB_4ADLZ = safeFileGetContents("data/addrd/media/media.txt");
...
'reply_to_message_id'=>$message->message_id,
 ...
 if($message->text and file_exists("data/addrd/$chat_id/$text.txt")) {
    $MoStaFa = safeFileGetContents("data/addrd/$chat_id/$text.txt");
   bot('SendMessage',[
    'chat_id'=>$chat_id,
    'text'=>$MoStaFa,
    'parse_mode'=>"html",
 ...
 if($message->text and file_exists("data/addrd/$chat_id/media/$text.txt")) {
  $MoStaFa = safeFileGetContents("data/addrd/$chat_id/media/$text.txt");
   bot('Sendvoice',[
    'chat_id'=>$chat_id,
    'voice'=>$MoStaFa,
    'reply_to_message_id'=>$message->message_id,
 ...
 if($message->text and file_exists("data/addrd/$chat_id/media/audio/$text.txt")) {
  $MoStaFa = safeFileGetContents("data/addrd/$chat_id/media/audio/$text.txt");
 bot('SendAudio',[
    'chat_id'=>$chat_id,
    'audio'=>$MoStaFa,
    'reply_to_message_id'=>$message->message_id,
 ...
 if($message->text and file_exists("data/addrd/$chat_id/media/sticker/$text.txt")) {
  $MoStaFa = safeFileGetContents("data/addrd/$chat_id/media/sticker/$text.txt");
 bot('sendsticker',[
'chat_id'=>$chat_id,
'sticker'=>$MoStaFa,
'reply_to_message_id'=>$message->message_id,
...
if($message->text and file_exists("data/addrd/$chat_id/media/video/$text.txt")) {
  $MoStaFa = safeFileGetContents("data/addrd/$chat_id/media/video/$text.txt");
bot('Sendvideo',[
'chat_id'=>$chat_id,
'video'=>$MoStaFa,
...
if($message->text and file_exists("data/addrd/$chat_id/media/photo/$text.txt")) {
  $MoStaFa = safeFileGetContents("data/addrd/$chat_id/media/photo/$text.txt");
bot('Sendphoto',[
'chat_id'=>$chat_id,
'photo'=>$MoStaFa,
'caption'=>$message->caption,
...
if($message->text and file_exists("data/addrd/$chat_id/media/videonote/$text.txt")) {
  $MoStaFa = safeFileGetContents("data/addrd/$chat_id/media/videonote/$text.txt");
 bot('Sendvideonote',[
'chat_id'=>$chat_id,
'video_note'=>$MoStaFa,
'reply_to_message_id'=>$message->message_id,
...
if($message->text and file_exists("data/addrd/$chat_id/media/document/$text.txt")) {
  $MoStaFa = safeFileGetContents("data/addrd/$chat_id/media/document/$text.txt");
 bot('SendDocument',[
'chat_id'=>$chat_id,
'document'=>$MoStaFa,
'reply_to_message_id'=>$message->message_id,
...
if($message->text and file_exists("data/addrd/$chat_id/media/contact/$text.txt")) {
 $MoStaFa = safeFileGetContents("data/addrd/$chat_id/media/contact/$text.txt");
bot('SendContact',[
'chat_id'=>$chat_id,
...
$kdeveloper = safeFileGetContents("kdevelopers.txt");
$kdevelopers = safeFileGetContents("kdeveloper.txt");
...
$game = json_decode(safeFileGetContents('game.json'),true);
$from_user = $message->from->username;
$from_name = $message->from->first_name;
$get_game = safeFileGetContents("game.txt");
$game1 = explode("\n",$get_game);
...
mkdir("game/$chat_id");
$level = safeFileGetContents("game/$chat_id/game.txt");
...
'parse_mode'=>"MARKDOWN",
'reply_to_message_id'=>$message->message_id, ]);
$msgs = json_decode(safeFileGetContents('msgs.json'),true);
$update = json_decode(safeFileGetContents('php://input'));
...
$edit = json_decode(safeFileGetContents('edit.json'),true);
...
$new = json_decode(safeFileGetContents('new.json'),true);
if($message->new_chat_member){
...
$idchange = safeFileGetContents("ok.txt");
if ( $status == 'creator' or $status == 'administrator' or in_array($from_id,$Dev) or in_array($from_id,$manger) or in_array($from_id,$admin_user) or in_array($from_id,$developer)){
...
$statjsond = json_decode(safeFileGetContents("https://api.telegram.org/bot$token/getChatMember?chat_id=$chat_id2&user_id=$from_id2"),true);
...
if($data == "2" ){
if( $statusd == 'creator' or $statusd == 'administrator' or in_array($from_id2,$Dev) or in_array($from_id2,$manger) or in_array($from_id2,$admin_user) or in_array($from_id2,$developer) or in_array($from_id2,$eri) or in_array($from_id2,$carlos) or in_array($from_id2,$nazar)) {
$statjsond = json_decode(safeFileGetContents("https://api.telegram.org/bot$token/getChatMember?chat_id=$chat_id2&user_id=".$from_id2),1);
$statusd = $statjsond['result']['status'];
bot('EditMessageText',[
'chat_id'=>$chat_id2,
'message_id'=>$message_id2,
...
$setnamebot = safeFileGetContents("setname.txt");
$namebot = safeFileGetContents("namebot.txt");
if($text=="/start" and $starttext == null){
$st1 = safeFileGetContents("startlock.txt");
if($st1 == "✔"){
if($tc == "private"){
if( !in_array($from_id,$Dev) && !in_array($from_id,$eri)){
bot('sendmessage',[
...
$starttext = safeFileGetContents("starttxt.txt");
if($text=="/start" and $starttext != null){
if($tc == "private"){
$st1 = safeFileGetContents("startlock.txt");
if($st1 == "✔"){
...
$startt = safeFileGetContents("start.txt");
$starttext = safeFileGetContents("starttxt.txt");
...
$Twassl = safeFileGetContents("twassl.txt");
$Twasl = safeFileGetContents("twasl.txt");
$locktwas = safeFileGetContents("openst.txt");
...
////////////////////////////////////////////////
$step1 = json_decode(safeFileGetContents("https://api.telegram.org/bot".API_KEY."/getChatMember?chat_id=$chat_id&user_id=$idBot"),true);
...
$idp == safeFileGetContents("data/$chat_id/bans.txt");
if ( $status == 'creator' or $status == 'administrator' or in_array($from_id,$Dev) or in_array($from_id,$manger) or in_array($from_id,$admin_user) or in_array($from_id,$developer) or in_array($from_id,$carlos) or in_array($from_id,$nazar) or in_array($from_id,$eri)) {
...
$silent = $settings["silentlist"];
for($z = 0;$z <= count($silent)-1;$z++){
$Apimktom = json_decode(safeFileGetContents("http://api.telegram.org/bot".API_KEY."/getChat?chat_id=$silent[$z]"));
...
$message_id = $message->message_id;
$gp_get = safeFileGetContents("Fri3nd_s/groups.txt");
$groups = explode("\n", $gp_get);
$GG1ZZ = safeFileGetContents("Fri3nd_s/iBadlz.txt");
$pirvate = explode("\n",safeFileGetContents("Fri3nd_s/pirvate.txt"));
...
if($rt and $text == "ضع صوره" or $text == "ضع صورة" and $re_msd->photo){
 $file = "https://api.telegram.org/file/bot".API_KEY."/".bot('getfile',['file_id'=>$re_msd->photo[1]->file_id])->result->file_path; file_put_contents("$chat_id.jpg",safeFileGetContents($file));
bot('setChatPhoto',[
'chat_id'=>$chat_id,
...
$Apitag = json_decode(safeFileGetContents("http://api.telegram.org/bot".API_KEY."/getChat?chat_id=$taag[$z]"));
...
$x = 0;
$tags = 0;
$get = safeFileGetContents("$chat_id.txt");
$getx = explode("\n", $get);
...
$datainfo = json_decode(safeFileGetContents("http://api.telegram.org/bot".API_KEY."/getChat?chat_id=$getx[$i]"));
...
$admin = "$ADMIN";
$sting = safeFileGetContents("sting.txt");
$band = safeFileGetContents("band.txt");
$start0 = safeFileGetContents("start1.txt") ;
$yhya5 = safeFileGetContents("yhya2.txt");
$knat1 = safeFileGetContents("knat1.txt");
$yhya0 = safeFileGetContents("yhya0.txt");
$yhya1= safeFileGetContents("yhya1.txt");
$yhya6 = safeFileGetContents("yhya3.txt");
$forward = $update->message->forward_from;
$MOhaMMed = count($pirvate)-1;
$MoHaMMedd = count($groups)-1;
$update = json_decode(safeFileGetContents('php://input'));
...
$aa =preg_replace('/AM/', 'ص', $d);$aa =preg_replace('/PM/', 'م', $d);
$message_id =  $update->callback_query->message->message_id;
$yhya = safeFileGetContents("yhya.txt");
$yhya2 = explode("\n",safeFileGetContents("yhya4.txt"));
$yhya3 = count($yhya2);
...
file_put_contents("co/$chat_id.png",safeFileGetContents($file));
bot('sendsticker',[
'chat_id'=>$chat_id,
...
file_put_contents("co/$chat_id.ogg",safeFileGetContents($file));
bot('sendvoice',[
'chat_id'=>$chat_id,
...
file_put_contents("co/$chat_id.mp3",safeFileGetContents($file));
bot('sendaudio',[
'chat_id'=>$chat_id,
...
$num= str_replace('تحميل ','',$text);
$abc = safeFileGetContents("https://harmof.ml/Youtuop/Youtapi.php?search=".urlencode($num));
...
$chatid = $update->callback_query->message->chat->id;
$K=json_decode(safeFileGetContents("https://harmof.ml/Api/youta9i.php?vid=http://www.youtube.com/watch?v=".$data), true); 
$VUrlUrl=$K['url'];
$file = $VUrlUrl;
file_put_contents("yotsbot.ogg",safeFileGetContents($file));
bot('sendVoice',[
'chat_id'=>$chatid,
...
$K=json_decode(safeFileGetContents("https://youtube-downloader3.herokuapp.com/video_info.php?url=$re_msd->text"), true); 
$V=$K['links'][0]['url'];
 $file = $V;
file_put_contents("ᴄᴀʀʟᴏѕ.ogg",safeFileGetContents($file));
bot('sendaudio',[
'chat_id'=>$chat_id,
...
$kindi = safeFileGetContents("kindi.txt");
...
$k = safeFileGetContents("https://aba.ae/en/ftplogin/nssar/apikindi/api.php?text=".$text);
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"$k ـ────────────
